...
public class Solution {
    ...
    //         heights.add(new Height(buildings[i][0], buildings[i][2], true));
    //         heights.add(new Height(buildings[i][1], buildings[i][2], false));
    //     }
    //     Collections.sort(heights, new Comparator<Height>() {
    //         public int compare(Height p1, Height p2) {
    //             if (p1.x == p2.x) {
    ...
    //     for (Height p : heights) {
    //         int curH = queue.peek();
    //         // start
    //         if(p.isStart){
    //             if(p.h > curH) {
    //                 if(curH!=0) {
    //                     ans.add(new ArrayList<Integer>(Arrays.asList(startT, p.x,curH)));
    //                 }
    //                 startT = p.x;
    //             }queue.add(p.h);
    //         // end
